...
* [Source Code](https://github.com/litestar-org/litestar) ⭐ 8,462 | 🐛 343 | 🌐 Python | 📅 2026-09-11 is hosted on GitHub.
...
* [`litestar-granian`](https://github.com/cofin/litestar-granian) ⭐ 44 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - A plugin for the [Granian](https://github.com/emmett-framework/granian) ⭐ 5,639 | 🐛 39 | 🌐 Rust | 📅 2026-09-14 HTTP server, written in Rust.<sup>\*</sup>
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,942 | 🐛 46 | 🌐 Python | 📅 2026-09-14 - An async ORM and query builder, supporting Postgres and SQLite,
...
* [`apitally`](https://github.com/apitally/apitally-py) ⭐ 225 | 🐛 7 | 🌐 Python | 📅 2026-09-15 - A plugin for easy API monitoring with [Apitally](https://apitally.io/litestar) (including API traffic, errors, response times, payload sizes and uptime).<sup>\*</sup>
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,057 | 🐛 495 | 🌐 Python | 📅 2026-09-11 - Python Serverless Microframework for AWS.
