...
* [Source Code](https://github.com/litestar-org/litestar) ⭐ 8,476 | 🐛 347 | 🌐 Python | 📅 2026-09-22 is hosted on GitHub.
...
* [`litestar-asyncpg`](https://github.com/litestar-org/litestar-asyncpg) ⭐ 15 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - A plugin for the AsyncPG database driver.<sup>\*</sup>
...
* [`modern-di`](https://github.com/modern-python/modern-di) ⭐ 66 | 🐛 7 | 🌐 Python | 📅 2026-09-20 - Dependency injection framework with IoC container and scopes, including [Litestar integration](https://github.com/modern-python/modern-di-litestar) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-21.
* [`litestar-granian`](https://github.com/cofin/litestar-granian) ⭐ 44 | 🐛 3 | 🌐 Python | 📅 2026-09-22 - A plugin for the [Granian](https://github.com/emmett-framework/granian) ⭐ 5,664 | 🐛 43 | 🌐 Rust | 📅 2026-09-14 HTTP server, written in Rust.<sup>\*</sup>
* [`litestar-saq`](https://github.com/litestar-org/litestar-saq) ⭐ 34 | 🐛 8 | 🌐 Python | 📅 2026-08-15 - A plugin for the [SAQ job queuing framework](https://github.com/tobymao/saq) ⭐ 888 | 🐛 0 | 🌐 Python | 📅 2026-08-14<sup>\*</sup>
...
* [Piccolo Admin](https://github.com/piccolo-orm/piccolo_admin) ⭐ 466 | 🐛 39 | 🌐 Python | 📅 2026-06-19 - A powerful and modern admin GUI, using the Piccolo
  ORM.
...
* [`litestar-auth`](https://github.com/ZYLVEXT/litestar-auth) ⭐ 3 | 🐛 10 | 🌐 Python | 📅 2026-09-20 - Production-ready authentication and authorization library for Litestar with JWT, password hashing, SQLAlchemy/Advanced Alchemy integration, optional Redis session storage, OAuth, and TOTP support.

### Databases

#### ORMs

* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,945 | 🐛 47 | 🌐 Python | 📅 2026-09-14 - An async ORM and query builder, supporting Postgres and SQLite,
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,057 | 🐛 498 | 🌐 Python | 📅 2026-09-11 - Python Serverless Microframework for AWS.
...
* [Litestar + SQLAlchemy 2 + PostgreSQL Template](https://github.com/modern-python/litestar-sqlalchemy-template) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2026-09-19 - Dockerized starter with dependency injection and Alembic. Made by [@modern-python](https://github.com/modern-python).
  <!--lint ignore awesome-list-item-->
* [Clean Architecture Litestar Project Template](https://github.com/Peopl3s/clean-architecture-litestar-project-template) ⭐ 26 | 🐛 45 | 🌐 Python | 📅 2026-09-22
