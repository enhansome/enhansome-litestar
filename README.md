...
* [Source Code](https://github.com/litestar-org/litestar) ⭐ 8,472 | 🐛 346 | 🌐 Python | 📅 2026-09-21 is hosted on GitHub.
...
* [`litestar-asyncpg`](https://github.com/litestar-org/litestar-asyncpg) ⭐ 14 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - A plugin for the AsyncPG database driver.<sup>\*</sup>
...
* [`litestar-granian`](https://github.com/cofin/litestar-granian) ⭐ 44 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - A plugin for the [Granian](https://github.com/emmett-framework/granian) ⭐ 5,660 | 🐛 42 | 🌐 Rust | 📅 2026-09-14 HTTP server, written in Rust.<sup>\*</sup>
...
* [Litestar + SQLAlchemy 2 + PostgreSQL Template](https://github.com/modern-python/litestar-sqlalchemy-template) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2026-09-19 - Dockerized starter with dependency injection and Alembic. Made by [@modern-python](https://github.com/modern-python).
  <!--lint ignore awesome-list-item-->
* [Clean Architecture Litestar Project Template](https://github.com/Peopl3s/clean-architecture-litestar-project-template) ⭐ 26 | 🐛 45 | 🌐 Python | 📅 2026-09-21
