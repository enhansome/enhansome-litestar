...
* [Source Code](https://github.com/litestar-org/litestar) ⭐ 8,469 | 🐛 343 | 🌐 Python | 📅 2026-09-17 is hosted on GitHub.
...
* [`litestar-asyncpg`](https://github.com/litestar-org/litestar-asyncpg) ⭐ 14 | 🐛 4 | 🌐 Python | 📅 2026-09-14 - A plugin for the AsyncPG database driver.<sup>\*</sup>
...
* [`dishka`](https://github.com/reagento/dishka) ⭐ 1,284 | 🐛 64 | 🌐 Python | 📅 2026-09-10 - Cute DI framework with agreeable API and everything you need, including [Litestar integration](https://dishka.readthedocs.io/en/stable/integrations/index.html).
* [`modern-di`](https://github.com/modern-python/modern-di) ⭐ 66 | 🐛 7 | 🌐 Python | 📅 2026-09-15 - Dependency injection framework with IoC container and scopes, including [Litestar integration](https://github.com/modern-python/modern-di-litestar) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-15.
* [`litestar-granian`](https://github.com/cofin/litestar-granian) ⭐ 44 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - A plugin for the [Granian](https://github.com/emmett-framework/granian) ⭐ 5,652 | 🐛 41 | 🌐 Rust | 📅 2026-09-14 HTTP server, written in Rust.<sup>\*</sup>
* [`litestar-saq`](https://github.com/litestar-org/litestar-saq) ⭐ 34 | 🐛 8 | 🌐 Python | 📅 2026-08-15 - A plugin for the [SAQ job queuing framework](https://github.com/tobymao/saq) ⭐ 886 | 🐛 0 | 🌐 Python | 📅 2026-08-14<sup>\*</sup>
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,942 | 🐛 47 | 🌐 Python | 📅 2026-09-14 - An async ORM and query builder, supporting Postgres and SQLite,
...
* [`apitally`](https://github.com/apitally/apitally-py) ⭐ 225 | 🐛 2 | 🌐 Python | 📅 2026-09-17 - A plugin for easy API monitoring with [Apitally](https://apitally.io/litestar) (including API traffic, errors, response times, payload sizes and uptime).<sup>\*</sup>
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,059 | 🐛 495 | 🌐 Python | 📅 2026-09-11 - Python Serverless Microframework for AWS.
...
* [Litestar + SQLAlchemy 2 + PostgreSQL Template](https://github.com/modern-python/litestar-sqlalchemy-template) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2026-09-13 - Dockerized starter with dependency injection and Alembic. Made by [@modern-python](https://github.com/modern-python).
  <!--lint ignore awesome-list-item-->
* [Clean Architecture Litestar Project Template](https://github.com/Peopl3s/clean-architecture-litestar-project-template) ⭐ 26 | 🐛 45 | 🌐 Python | 📅 2026-09-17
