...
* [Source Code](https://github.com/litestar-org/litestar) ⭐ 8,399 | 🐛 308 | 🌐 Python | 📅 2026-08-17 is hosted on GitHub.
...
* [`litestar-asyncpg`](https://github.com/litestar-org/litestar-asyncpg) ⭐ 14 | 🐛 4 | 🌐 Python | 📅 2026-08-17 - A plugin for the AsyncPG database driver.<sup>\*</sup>
...
* [`litestar-granian`](https://github.com/cofin/litestar-granian) ⭐ 44 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - A plugin for the [Granian](https://github.com/emmett-framework/granian) ⭐ 5,556 | 🐛 41 | 🌐 Rust | 📅 2026-08-05 HTTP server, written in Rust.<sup>\*</sup>
* [`litestar-saq`](https://github.com/litestar-org/litestar-saq) ⭐ 31 | 🐛 8 | 🌐 Python | 📅 2026-08-15 - A plugin for the [SAQ job queuing framework](https://github.com/tobymao/saq) ⭐ 879 | 🐛 2 | 🌐 Python | 📅 2026-08-14<sup>\*</sup>
...
* [`apitally`](https://github.com/apitally/apitally-py) ⭐ 224 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - A plugin for easy API monitoring with [Apitally](https://apitally.io/litestar) (including API traffic, errors, response times, payload sizes and uptime).<sup>\*</sup>
