...
* [Source Code](https://github.com/litestar-org/litestar) ⭐ 8,478 | 🐛 348 | 🌐 Python | 📅 2026-09-23 is hosted on GitHub.
...
* [`litestar-granian`](https://github.com/cofin/litestar-granian) ⭐ 44 | 🐛 3 | 🌐 Python | 📅 2026-09-22 - A plugin for the [Granian](https://github.com/emmett-framework/granian) ⭐ 5,668 | 🐛 43 | 🌐 Rust | 📅 2026-09-14 HTTP server, written in Rust.<sup>\*</sup>
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,946 | 🐛 47 | 🌐 Python | 📅 2026-09-14 - An async ORM and query builder, supporting Postgres and SQLite,
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,056 | 🐛 498 | 🌐 Python | 📅 2026-09-11 - Python Serverless Microframework for AWS.
...
* [Litestar + SQLAlchemy 2 + PostgreSQL Template](https://github.com/modern-python/litestar-sqlalchemy-template) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2026-09-19 - Dockerized starter with dependency injection and Alembic. Made by [@modern-python](https://github.com/modern-python).
  <!--lint ignore awesome-list-item-->
* [Clean Architecture Litestar Project Template](https://github.com/Peopl3s/clean-architecture-litestar-project-template) ⭐ 26 | 🐛 45 | 🌐 Python | 📅 2026-09-23
