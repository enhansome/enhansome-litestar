...
| Project   |    | Status                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| --------- | :- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CI/CD     |    | [![CI](https://github.com/litestar-org/awesome-litestar/actions/workflows/ci.yml/badge.svg)](https://github.com/litestar-org/awesome-litestar/actions/workflows/ci.yml) ⭐ 168 \| 🐛 3 \| 🌐 Makefile \| 📅 2026-07-07 [![Link Check](https://github.com/litestar-org/awesome-litestar/actions/workflows/expired-links.yml/badge.svg)](https://github.com/litestar-org/awesome-litestar/actions/workflows/expired-links.yml) ⭐ 168 \| 🐛 3 \| 🌐 Makefile \| 📅 2026-07-07                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
* [Source Code](https://github.com/litestar-org/litestar) ⭐ 8,450 | 🐛 337 | 🌐 Python | 📅 2026-09-08 is hosted on GitHub.
...
* [`litestar-asyncpg`](https://github.com/litestar-org/litestar-asyncpg) ⭐ 14 | 🐛 4 | 🌐 Python | 📅 2026-08-31 - A plugin for the AsyncPG database driver.<sup>\*</sup>
* [`litestar-vite`](https://github.com/litestar-org/vite-plugin) ⚠️ Archived - A Vite adapter for Litestar.
* [`litestar-piccolo`](https://github.com/litestar-org/litestar-piccolo) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2024-11-25 - A Piccolo ORM adapter for Litestar.<sup>\*</sup>
...
* [`dishka`](https://github.com/reagento/dishka) ⭐ 1,279 | 🐛 65 | 🌐 Python | 📅 2026-09-01 - Cute DI framework with agreeable API and everything you need, including [Litestar integration](https://dishka.readthedocs.io/en/stable/integrations/index.html).
* [`modern-di`](https://github.com/modern-python/modern-di) ⭐ 66 | 🐛 5 | 🌐 Python | 📅 2026-09-08 - Dependency injection framework with IoC container and scopes, including [Litestar integration](https://github.com/modern-python/modern-di-litestar) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-07.
* [`litestar-granian`](https://github.com/cofin/litestar-granian) ⭐ 44 | 🐛 3 | 🌐 Python | 📅 2026-09-04 - A plugin for the [Granian](https://github.com/emmett-framework/granian) ⭐ 5,619 | 🐛 41 | 🌐 Rust | 📅 2026-09-01 HTTP server, written in Rust.<sup>\*</sup>
* [`litestar-saq`](https://github.com/litestar-org/litestar-saq) ⭐ 33 | 🐛 8 | 🌐 Python | 📅 2026-08-15 - A plugin for the [SAQ job queuing framework](https://github.com/tobymao/saq) ⭐ 882 | 🐛 0 | 🌐 Python | 📅 2026-08-14<sup>\*</sup>
...
* [`litestar-svcs`](https://github.com/vkcku/litestar-svcs) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2023-11-30 - A plugin for the [SVCS](https://github.com/hynek/svcs) ⭐ 420 | 🐛 2 | 🌐 Python | 📅 2026-09-08 service locater/dependency injection library.<sup>\*</sup>
...
* [Piccolo Admin](https://github.com/piccolo-orm/piccolo_admin) ⭐ 467 | 🐛 39 | 🌐 Python | 📅 2026-06-19 - A powerful and modern admin GUI, using the Piccolo
  ORM.
* [SQLAdminPlugin](https://github.com/peterschutt/sqladmin-litestar-plugin) ⭐ 33 | 🐛 8 | 🌐 Python | 📅 2025-12-15 - Integrates SQLAdmin with a Litestar application.
* [StarletteAdminPlugin](https://github.com/noamsto/starlette-admin-litestar-plugin) ⚠️ Archived - Integrates Starlette Admin with a Litestar application.

### Auth

* [`litestar-users`](https://github.com/mvbosch/litestar-users) ⭐ 100 | 🐛 6 | 🌐 Python | 📅 2026-07-10 - Authentication and user management for the
  Litestar framework.<sup>\*</sup>
* [`litestar-auth`](https://github.com/ZYLVEXT/litestar-auth) ⭐ 3 | 🐛 10 | 🌐 Python | 📅 2026-09-06 - Production-ready authentication and authorization library for Litestar with JWT, password hashing, SQLAlchemy/Advanced Alchemy integration, optional Redis session storage, OAuth, and TOTP support.

### Databases

#### ORMs

* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,940 | 🐛 44 | 🌐 Python | 📅 2026-09-07 - An async ORM and query builder, supporting Postgres and SQLite,
...
* [`apitally`](https://github.com/apitally/apitally-py) ⭐ 225 | 🐛 6 | 🌐 Python | 📅 2026-09-08 - A plugin for easy API monitoring with [Apitally](https://apitally.io/litestar) (including API traffic, errors, response times, payload sizes and uptime).<sup>\*</sup>
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,057 | 🐛 494 | 🌐 Python | 📅 2026-09-08 - Python Serverless Microframework for AWS.
...
* [Litestar Fullstack with Vite, VueJS, Redis, PostgreSQL, and more](https://github.com/litestar-org/litestar-fullstack) ⭐ 610 | 🐛 19 | 🌐 Python | 📅 2026-08-03 - Made by [@cofin](https://github.com/cofin/).
* [Litestar + SQLAlchemy 2 + PostgreSQL Template](https://github.com/modern-python/litestar-sqlalchemy-template) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - Dockerized starter with dependency injection and Alembic. Made by [@modern-python](https://github.com/modern-python).
  <!--lint ignore awesome-list-item-->
* [Clean Architecture Litestar Project Template](https://github.com/Peopl3s/clean-architecture-litestar-project-template) ⭐ 25 | 🐛 45 | 🌐 Python | 📅 2026-09-08
...
* [Network Information API](https://github.com/JacobCoffee/niapi) ⭐ 17 | 🐛 12 | 🌐 Python | 📅 2024-04-28 - Toy app with TailwindCSS and HTMX.
* [Litestar with OAuth2 Example](https://github.com/johnfaucette/litestar-oauth2-example) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2023-07-26 - Example of using Litestar with OAuth2.
