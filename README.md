...
* [Source Code](https://github.com/litestar-org/litestar) ⭐ 8,425 | 🐛 319 | 🌐 Python | 📅 2026-08-28 is hosted on GitHub.
...
* [`dishka`](https://github.com/reagento/dishka) ⭐ 1,266 | 🐛 66 | 🌐 Python | 📅 2026-08-25 - Cute DI framework with agreeable API and everything you need, including [Litestar integration](https://dishka.readthedocs.io/en/stable/integrations/index.html).
...
* [`litestar-granian`](https://github.com/cofin/litestar-granian) ⭐ 44 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - A plugin for the [Granian](https://github.com/emmett-framework/granian) ⭐ 5,571 | 🐛 38 | 🌐 Rust | 📅 2026-08-23 HTTP server, written in Rust.<sup>\*</sup>
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,937 | 🐛 45 | 🌐 Python | 📅 2026-08-07 - An async ORM and query builder, supporting Postgres and SQLite,
...
* [`apitally`](https://github.com/apitally/apitally-py) ⭐ 224 | 🐛 6 | 🌐 Python | 📅 2026-08-27 - A plugin for easy API monitoring with [Apitally](https://apitally.io/litestar) (including API traffic, errors, response times, payload sizes and uptime).<sup>\*</sup>
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,061 | 🐛 493 | 🌐 Python | 📅 2026-08-12 - Python Serverless Microframework for AWS.
...
* [Litestar + SQLAlchemy 2 + PostgreSQL Template](https://github.com/modern-python/litestar-sqlalchemy-template) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2026-07-13 - Dockerized starter with dependency injection and Alembic. Made by [@modern-python](https://github.com/modern-python).
  <!--lint ignore awesome-list-item-->
* [Clean Architecture Litestar Project Template](https://github.com/Peopl3s/clean-architecture-litestar-project-template) ⭐ 25 | 🐛 45 | 🌐 Python | 📅 2026-08-27
