...
* [Source Code](https://github.com/litestar-org/litestar) ⭐ 8,455 | 🐛 340 | 🌐 Python | 📅 2026-09-08 is hosted on GitHub.
...
* [`dishka`](https://github.com/reagento/dishka) ⭐ 1,281 | 🐛 64 | 🌐 Python | 📅 2026-09-10 - Cute DI framework with agreeable API and everything you need, including [Litestar integration](https://dishka.readthedocs.io/en/stable/integrations/index.html).
...
* [`litestar-saq`](https://github.com/litestar-org/litestar-saq) ⭐ 33 | 🐛 8 | 🌐 Python | 📅 2026-08-15 - A plugin for the [SAQ job queuing framework](https://github.com/tobymao/saq) ⭐ 884 | 🐛 0 | 🌐 Python | 📅 2026-08-14<sup>\*</sup>
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,941 | 🐛 45 | 🌐 Python | 📅 2026-09-07 - An async ORM and query builder, supporting Postgres and SQLite,
...
* [`apitally`](https://github.com/apitally/apitally-py) ⭐ 225 | 🐛 6 | 🌐 Python | 📅 2026-09-10 - A plugin for easy API monitoring with [Apitally](https://apitally.io/litestar) (including API traffic, errors, response times, payload sizes and uptime).<sup>\*</sup>
...
* [Chalice](https://github.com/aws/chalice) ⭐ 11,056 | 🐛 495 | 🌐 Python | 📅 2026-09-10 - Python Serverless Microframework for AWS.
...
* [Litestar + SQLAlchemy 2 + PostgreSQL Template](https://github.com/modern-python/litestar-sqlalchemy-template) ⭐ 35 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - Dockerized starter with dependency injection and Alembic. Made by [@modern-python](https://github.com/modern-python).
  <!--lint ignore awesome-list-item-->
* [Clean Architecture Litestar Project Template](https://github.com/Peopl3s/clean-architecture-litestar-project-template) ⭐ 26 | 🐛 45 | 🌐 Python | 📅 2026-09-09
